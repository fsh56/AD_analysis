#!/usr/bin/env Rscript
# =============================================================================
# MR Analysis for amygdala Clumped Data
...
if (length(args) < 2) {
  stop("Usage: Rscript mr_analysis_amy.R <chromosome_number> <base_dir>
       Example: Rscript mr_analysis_amy.R 1 /gpfs/data/gao-lab/people/Sihao/amyloid_ba9")
}
