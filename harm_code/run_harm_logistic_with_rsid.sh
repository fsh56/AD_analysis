...
#SBATCH --output=/gpfs/data/gao-lab/people/Sihao/ad_analysis/logs/harmonize_logistic%j.out
#SBATCH --error=/gpfs/data/gao-lab/people/Sihao/ad_analysis/logs/harmonize_logistic%j.err
#SBATCH --time=6:00:00
#SBATCH --mem=32G
...
# run R script
Rscript harm_logistic_with_rsid.R ${GWAS_FILE} ${TISSUE}
