...
#SBATCH --output=/gpfs/data/gao-lab/people/Sihao/amyloid_amydgala/logs/mr_seso%j.out
#SBATCH --error=/gpfs/data/gao-lab/people/Sihao/amyloid_amydgala/logs/mr_seso%j.err
#SBATCH --time=6:00:00
#SBATCH --mem=64G
...
INPUT_DIR="/scratch/sfeng56/ad_analysis/amyloid/Amygdala"
OUTPUT_BASE="/gpfs/data/gao-lab/people/Sihao/amyloid_amydgala/mr_results"
...
echo "======================================================================"
echo "Starting MR SESO analysis for amyloid Amygdala data"
echo "Date: $(date)"
echo "======================================================================"
echo ""
...
declare -a INPUT_FILES=(
  "${INPUT_DIR}/clumped_amyloid_Amydgala_1_w20kb_p0.0001.txt"
  "${INPUT_DIR}/clumped_amyloid_Amydgala_1_w20kb_p0.001.txt"
)
