...
if (length(args) < 2) {
  cat("Usage: Rscript harmonize_linear_with_rsid.R <gwas_file_name> <tissue_name>\n")
  cat("Example: Rscript harmonize_linear_with_rsid.R amyloid.assoc.linear.with_rsid.txt.gz Brain_Amygdala\n")
  quit(status = 1)
}
